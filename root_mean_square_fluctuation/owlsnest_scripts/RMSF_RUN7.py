...
for i in range(10000):
    try:
        t = md.load('../curated_RUN7_p14188/RUN7CLONE%d.xtc'%i,top='../p14188-r6-c0.gro')
...
for i in range(0,700):
    M2_r7_res[i] = [item[i] for item in rmsf_list]


np.save("M2_r7_res", M2_r7_res)


rmsf_avg_grp_1 = []
for j in range(700):
    res_list = M2_r7_res[j]
...
for j in range(700):
    ...
    for i in range(1000):  # boot strapping
        ...
        np.save('./individual_means/M2_r7_res%d' %j, group1_avg)
